...
// -----------------------------------------------------
//            ncrement the version number at the very
...
open class Snapshot: NSObject {
    ...
    open class func snapshot(_ name: String, timeWaitingForIdle timeout: TimeInterval = 20) {
        ...
        print("snapshot: \(name)") //check out https://docs.fastlane.tools/actions/snapshot/#how-does-it-work
...
// Increment the version of the Snapshot below everytime a change is made
